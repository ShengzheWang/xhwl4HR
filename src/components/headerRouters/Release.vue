      ...
      <div style="width:60%;margin: 2% auto 0 auto">
        <el-tabs >
          ...
          <el-tab-pane label="工作职责">
            <el-form label-width="120px" style="width: 80%;;display: inline-block;margin-left: 7%;margin-top:5%" :rules="rules" ref="form2" :model="form2">
          ...
          <el-tab-pane label="职位要求">
            <el-form  label-width="120px" style="width: 80%;;display: inline-block;margin-left: 7%;margin-top:5%" :rules="rules" ref="form3" :model="form3">
